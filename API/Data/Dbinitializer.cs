        ...
        public static void Initialize(StoreContext context)
        {
            ...
            var products = new List<Product>
            {
                ...
                new Product
                {
                    ...
                    Collection = "Jordan 1",
                    Sizes = new List<Size> { new Size { Value = 42.5f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Jordan 1",
                    Sizes = new List<Size> { new Size { Value = 44.5f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Jordan 1",
                    Sizes = new List<Size> { new Size { Value = 39 }, new Size { Value = 38 }, new Size { Value = 37.5f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Jordan 1",
                    Sizes = new List<Size>{new Size { Value = 42.5f }, new Size { Value = 43 }, new Size { Value = 44 }},
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Jordan 1",
                    Sizes = new List<Size> { new Size { Value = 45.5f }, new Size { Value = 44 }, new Size { Value = 44.5f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Jordan 1",
                    Sizes = new List<Size> { new Size { Value = 37 }, new Size { Value = 38.5f }, new Size { Value = 39 } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Dunks",
                    Sizes = new List<Size> { new Size { Value = 39f }, new Size { Value = 40.5f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Dunks",
                    Sizes = new List<Size> { new Size { Value = 38f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Dunks",
                    Sizes = new List<Size> { new Size { Value = 36.5f }, new Size { Value = 38f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Dunks",
                    Sizes = new List<Size> { new Size { Value = 38.5f } },
                    QuantityInStock = 100,
                    ReleaseDate = new DateTime(2022, 03 , 01),
                    Condition = "Brand  new",
                    Style = "DJ6188-100"
                ...
                new Product
                {
                    ...
                    Collection = "Dunks",
                    Sizes = new List<Size> { new Size { Value = 37.5f }, new Size { Value = 38.5f }, new Size { Value = 39f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Dunks",
                    Sizes = new List<Size> { new Size { Value = 42f } },
                    QuantityInStock = 100,
                ...
                new Product
                {
                    ...
                    Collection = "Dunks",
                    Sizes = new List<Size> { new Size { Value = 38.5f }, new Size { Value = 39 } },
                    QuantityInStock = 100,
