...
export const addCartItemAsync = createAsyncThunk<Cart, { productId: number, quantity?: number, size?: number }>(
...
export const removeCartItemAsync = createAsyncThunk<void,
    { productId: number, quantity: number, name?: string, size?: number }>(
        'cart/reoveCartItemAsync',
