                ...
                <TextField
                    ...
                    {...register('password', { 
                        ...
                        pattern: {
                            ...
                            message: 'Password must be between 8 and 15 characters, and contain at least one lowercase letter, one uppercase letter, one numeric digit, and one special character'
                        }
                    })}
